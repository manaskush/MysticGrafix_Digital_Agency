...
export default function PackagingAndProductDesignPage() {
  return (
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-700 py-12">
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              ...
              <span>Services</span>
              <ChevronRight className="w-4 h-4" />
              <span className="text-white">Packaging & Product Design</span>
            </motion.div>
            ...
            >
              Create shelf-worthy packaging and product designs that turn heads, build trust, and drive purchases.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideIn}>
              <h2 className="text-3xl font-bold mb-6 text-white">
                Designs That Speak Before You Do
              </h2>
              <p className="text-gray-300 mb-6 leading-relaxed text-lg">
                We specialize in strategic packaging and product design that blends form, function, and brand voice — helping your product stand out online and on the shelf.
              </p>

              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Package, text: 'Packaging Design' },
                  { icon: PenTool, text: 'Product Label Design' },
                  { icon: Ruler, text: 'Structural Mockups' },
                  { icon: Layers, text: 'Brand-Aligned Aesthetics' },
                ].map((item, i) => (
                  <motion.div
                    key={i}
            ...
            >
              ...
              <p className="text-center text-gray-300 text-sm">Brand-Driven, Shelf-Ready Design</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 bg-neutral-800">
          <div className="max-w-6xl mx-auto px-4">
            <motion.div className="text-center mb-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              <h2 className="text-3xl font-bold mb-4 text-white">Why Brands Choose Our Design Studio</h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                We blend creative precision with brand consistency to deliver packaging that sells and sticks.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Zap, title: 'Visually Compelling', desc: 'Catch attention and spark emotion' },
                { icon: Shield, title: 'Strategically Aligned', desc: 'Designs that serve brand goals' },
                { icon: Clock, title: 'Timely Delivery', desc: 'Quick execution, zero compromise' },
                { icon: Headphones, title: 'Collaborative Approach', desc: 'Your vision, our execution' },
              ].map((item, i) => (
                <motion.div
                  key={i}
          ...
          <motion.div className="max-w-4xl mx-auto px-4 text-center" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            ...
            <div className="flex items-center justify-center gap-8 mt-8 pt-8 border-t border-white/20">
              <div className="flex items-center gap-1">
                ...
                <span className="text-white ml-2">120+ Product Designs Launched</span>
              </div>
            </div>
          </motion.div>
        </section>

      ...
      <main>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-700 py-12">
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              ...
              <span>Services</span>
              <ChevronRight className="w-4 h-4" />
              <span className="text-white">3D & Motion Graphics</span>
            </motion.div>
            ...
            >
              Transform ideas into dynamic visual experiences with animation, 3D design, and cinematic storytelling.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideIn}>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Video, text: 'Explainer Videos' },
                  { icon: Film, text: 'Brand Animation' },
                  { icon: Camera, text: 'Product Showcases' },
                  { icon: Eye, text: 'Visual Effects (VFX)' },
                ].map((item, i) => (
                  <motion.div
                    key={i}
            ...
            >
              ...
              <p className="text-center text-gray-300 text-sm">High-Impact Motion Graphics</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 bg-neutral-800">
          <div className="max-w-6xl mx-auto px-4">
            <motion.div className="text-center mb-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              <h2 className="text-3xl font-bold mb-4 text-white">Why Choose Our 3D & Motion Services?</h2>
              <p className="text-gray-400 max-w-2xl mx-auto">Creative storytelling meets cutting-edge visuals to deliver immersive experiences</p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Zap, title: 'Creative Impact', desc: 'Stunning animations that elevate your brand image' },
                { icon: Shield, title: 'Professional Quality', desc: 'Industry-standard tools & cinematic polish' },
                { icon: Clock, title: 'Timely Delivery', desc: 'Fast turnaround without sacrificing quality' },
                { icon: Headphones, title: 'End-to-End Support', desc: 'From concept to final render — we’re with you' },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600">
          <motion.div className="max-w-4xl mx-auto px-4 text-center" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h3 className="text-3xl font-bold mb-4 text-white">Let&apos;s Animate Your Vision</h3>
            <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
              Book a free consultation and explore how 3D & motion graphics can transform your brand.
            </p>
            ...
            <div className="flex items-center justify-center gap-8 mt-8 pt-8 border-t border-white/20">
              <div className="flex items-center gap-1">
                ...
                <span className="text-white ml-2">200+ Successful Visual Campaigns</span>
              </div>
            </div>
          </motion.div>
        </section>

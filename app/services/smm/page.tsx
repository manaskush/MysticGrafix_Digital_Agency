      ...
      <main>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-700 py-12">
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              Build your brand, engage your audience, and drive results through powerful social media strategies tailored for your business.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideIn}>
              <h2 className="text-3xl font-bold mb-6 text-white">
                Grow Your Audience and Amplify Your Message
              </h2>
              <p className="text-gray-300 mb-6 leading-relaxed text-lg">
                Our social media marketing experts create content, manage campaigns, and optimize engagement across platforms like Instagram, Facebook, TikTok, and LinkedIn to ensure your brand stands out and connects.
              </p>

              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: ThumbsUp, text: 'Content Creation' },
                  { icon: MessageCircle, text: 'Community Management' },
                  { icon: BarChart, text: 'Analytics & Reporting' },
                  { icon: Share2, text: 'Paid Ad Campaigns' },
                ].map((item, i) => (
                  <motion.div
                    key={i}
            ...
            >
              ...
              <p className="text-center text-gray-300 text-sm">Real-Time Engagement & ROI Tracking</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 bg-neutral-800">
          <div className="max-w-6xl mx-auto px-4">
            <motion.div className="text-center mb-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              <h2 className="text-3xl font-bold mb-4 text-white">Why Choose Our Social Media Services?</h2>
              <p className="text-gray-400 max-w-2xl mx-auto">We help brands build meaningful relationships and measurable results across platforms.</p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Zap, title: 'Creative Content', desc: 'Scroll-stopping visuals & captions that convert' },
                { icon: Shield, title: 'Reputation Management', desc: 'We protect & grow your brand’s online image' },
                { icon: Clock, title: 'Consistent Posting', desc: 'Never miss a moment or opportunity to connect' },
                { icon: Headphones, title: 'Full-Service Support', desc: 'From strategy to execution, we handle it all' },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600">
            ...
            <div className="flex items-center justify-center gap-8 mt-8 pt-8 border-t border-white/20">
              <div className="flex items-center gap-1">
                ...
                <span className="text-white ml-2">150+ Campaigns Successfully Managed</span>
              </div>
            </div>
          </motion.div>
        </section>

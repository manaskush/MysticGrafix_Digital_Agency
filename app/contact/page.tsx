...
const FormSchema = z.object({
  ...
  help: z.enum([
    "Evaluate MysticGrafix for my company",
    "Learn More",
    "Get a Quote",
    "Other",
  ]),
...
type FormValues = {
  ...
  job_title: string;
  company_name: string;
  help: "Evaluate MysticGrafix for my company" | "Learn More" | "Get a Quote" | "Other";
  services:
    | "Website Development"
    | "Social Media Marketing"
    | "UI/UX Design"
          ...
          <div
            className="
              ...
              text-gray-300
                    "
          >
            Let&apos;s talk about how MysticGrafix can help your team work better.
          </div>
            ...
            >
                  ...
                  <FormItem className="items-center justify-center w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="51-200"> UI/UX Design</SelectItem>
                        <SelectItem value="501-1000">Branding</SelectItem>
                        <SelectItem value="501-1000">Animations</SelectItem>
                        <SelectItem value="501-1000">Photo Manipulations</SelectItem>
                        <SelectItem value="1000+">Video Production</SelectItem>
                      </SelectContent>
                    </Select>
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem className="items-center justify-center  w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        <div className="flex gap-4">
                          <SelectItem value="Evaluate MysticGrafix for my company">
                            Evaluate MysticGrafix for my company
                          </SelectItem>
                        </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to MysticGrafix sending marketing communications related
                  to MysticGrafix
                </div>
              </div>
